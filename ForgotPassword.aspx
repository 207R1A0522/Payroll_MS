<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Payroll_Mangmt_sys.ForgotPassword" %>
...
<asp:TextBox ID="email" runat="server" class="form-control p-4" Placeholder="Enter your email"></asp:TextBox>
...
<asp:Button ID="FporgotPwdBtn" runat="server" class="btn btn-primary py-3 px-5" Text="Submit" OnClick="ForgotPwdBtn_Click" />
</div>
</div>
</div>
</div>
